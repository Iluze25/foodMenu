...
// Child Name List
for (x in ToastSeriesArray) {
  // Flavor
  const Flavor = document.createElement("div");
  Flavor.setAttribute("class", "NameList Flavor");
  Flavor.textContent = ToastSeriesArray[x].Flavor;
  ...
  SelimutHijau.textContent = ToastSeriesArray[x].PriceSelimutHijau;
  ...
  WheatToast.textContent = ToastSeriesArray[x].PriceWheatToast;
  ...
  SpecialToast.textContent = ToastSeriesArray[x].PriceSpecialToast;
